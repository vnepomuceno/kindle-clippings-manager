  ...
  module Repository
    class Books
      ...
      def upsert(book)
        ...
        find_result = connection[COLLECTION_NAME].find(book_title: book.book_title, author: book.author)
        if find_result.count.zero?
          connection[COLLECTION_NAME].insert_one(book_title: book.book_title, author: book.author,
